...
public class AllCouponFragment extends BaseFragment implements FragmentChangeListener, View.OnClickListener {
    ...
    private void init() {
        if (getArguments() == null)
            return;
        categoryWiseList = getArguments().getParcelableArrayList("allCoupon");
