...
public class DealTypeFragment extends BaseFragment implements FragmentChangeListener, View.OnClickListener {
    ...
    private void init() {
        if (getArguments() == null)
            return;
        categoryWiseList = getArguments().getParcelableArrayList("deals");
