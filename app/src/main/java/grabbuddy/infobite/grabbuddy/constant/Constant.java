...
public class Constant {
    ...
    public static final String SIDE_BANNER = "androidapi/slider-side-banner.php";

    /*https://grabbuddy.in/androidapi/slider-side-banner.php*/
    ...
    public static final String IMAGE6 = "https://www.grabbuddy.in/admin/images/slider_side_bannar/";
